<div wire:ignore class="bg-white shadow-md p-5 rounded-md">
    <h2 class="text-center text-lg font-semibold mb-4">Laporan Laba Rugi</h2>
    <p class="text-center text-sm text-gray-500 mb-4">Data ini menunjukkan distribusi laporan laba rugi.</p>
